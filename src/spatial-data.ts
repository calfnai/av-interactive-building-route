...
export const ROUTE_EVENTS: RouteEvent[] = [
  ...
  event("u1-f8-door-a", 6, p(1, 8, -1.65, 1.55), "进入 8F 住户门", "从 1 单元 8 楼公共区进入住户私宅，不经过电梯厅。", "access", 1, 8),
  ...
  event("u1-f7-public-b", 7, p(1, 7, 0, 0), "离开 7F 住户", "回到 1 单元 7 楼公共区。", "move", 1, 7),
  event("u1-f6-public-again", 7, p(1, 6, 0, 0), "再次下行至 6F", "第二次返回 6 楼公共区域。", "move", 1, 6),
  event("u1-f6-room-c", 7, p(1, 6, 2.15, 3.15), "误入 6F C 户", "另一处错误住户私宅，室内通道仍会错回 7 楼。", "wrong", 1, 6),
  event("u1-f7-room-c", 7, p(1, 7, 2.15, 3.15), "室内再次错回 7F", "保留第二次错误跨层穿行。", "wrong", 1, 7),
  event("u1-f6-public-third", 8, p(1, 6, 0, 0), "最终回到 6F", "从 7 楼住户空间退出，第三次到达 6 楼公共区。", "move", 1, 6),
